...
func DevicePlot(plotType string, datas []float32, timestamps []time.Time) templ.Component {
	return templ.ComponentFunc(func(templ_7745c5c3_Ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString("plot-" + plotType))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func graph(plotType string, datas []float32, timestamps []time.Time) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_graph_933c`,
		Function: `function __templ_graph_933c(plotType, datas, timestamps){var trace1 = {
        x: timestamps,
        y: datas,
        type: "scatter",
    };
    Plotly.newPlot("plot-" + plotType, [trace1]);}`,
		Call: templ.SafeScript(`__templ_graph_933c`, plotType, datas, timestamps),
	}
}
